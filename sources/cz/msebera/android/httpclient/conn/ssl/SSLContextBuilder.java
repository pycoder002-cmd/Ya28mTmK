...
public class SSLContextBuilder {
    ...
    public SSLContext build() throws NoSuchAlgorithmException, KeyManagementException {
        ...
        sSLContext.init(!this.keymanagers.isEmpty() ? (KeyManager[]) this.keymanagers.toArray(new KeyManager[this.keymanagers.size()]) : null, this.trustmanagers.isEmpty() ? null : (TrustManager[]) this.trustmanagers.toArray(new TrustManager[this.trustmanagers.size()]), this.secureRandom);
        return sSLContext;
    }
