...
public class ResponseContentEncoding implements HttpResponseInterceptor {
    ...
    public ResponseContentEncoding(Lookup<InputStreamFactory> lookup) {
        this.decoderRegistry = lookup == null ? RegistryBuilder.create().register(ContentCodingType.GZIP_VALUE, GZIP).register("x-gzip", GZIP).register("deflate", DEFLATE).build() : lookup;
    }
