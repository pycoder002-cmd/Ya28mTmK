...
public abstract class AbstractHttpClient extends CloseableHttpClient {
    ...
    protected final CloseableHttpResponse doExecute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) throws IOException, ClientProtocolException {
        ...
        try {
            ...
            HttpRoute determineRoute = routePlanner.determineRoute(httpHost2, httpRequest2, httpContext3);
            try {
                try {
                    CloseableHttpResponse newProxy = CloseableHttpResponseProxy.newProxy(createClientRequestDirector.execute(httpHost, httpRequest2, httpContext3));
