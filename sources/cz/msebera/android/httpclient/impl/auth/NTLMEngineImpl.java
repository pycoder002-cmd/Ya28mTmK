...
public final class NTLMEngineImpl implements NTLMEngine {
    ...
    public static class MD4 {
        ...
        protected void processBuffer() {
            ...
            for (int i = 0; i < 16; i++) {
                int i2 = i * 4;
                iArr[i] = (this.dataBuffer[i2] & FileDownloadStatus.error) + ((this.dataBuffer[i2 + 1] & FileDownloadStatus.error) << 8) + ((this.dataBuffer[i2 + 2] & FileDownloadStatus.error) << 16) + ((this.dataBuffer[i2 + 3] & FileDownloadStatus.error) << 24);
            }
            int i3 = this.A;
            int i4 = this.B;
            int i5 = this.C;
    ...
    public static Key createDESKey(byte[] bArr, int i) {
        ...
        byte[] bArr3 = {bArr2[0], (byte) ((bArr2[0] << 7) | ((bArr2[1] & FileDownloadStatus.error) >>> 1)), (byte) ((bArr2[1] << 6) | ((bArr2[2] & FileDownloadStatus.error) >>> 2)), (byte) ((bArr2[2] << 5) | ((bArr2[3] & FileDownloadStatus.error) >>> 3)), (byte) ((bArr2[3] << 4) | ((bArr2[4] & FileDownloadStatus.error) >>> 4)), (byte) ((bArr2[4] << 3) | ((bArr2[5] & FileDownloadStatus.error) >>> 5)), (byte) ((bArr2[5] << 2) | ((bArr2[6] & FileDownloadStatus.error) >>> 6)), (byte) (bArr2[6] << 1)};
        oddParity(bArr3);
    ...
    public static int readUShort(byte[] bArr, int i) throws NTLMEngineException {
        ...
        return ((bArr[i + 1] & FileDownloadStatus.error) << 8) | (bArr[i] & FileDownloadStatus.error);
    }
