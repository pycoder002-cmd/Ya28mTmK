...
public final class RealBufferedSource implements BufferedSource {
    ...
    public InputStream inputStream() {
        return new InputStream() { // from class: okio.RealBufferedSource.1
            ...
            public int read() throws IOException {
                ...
                return RealBufferedSource.this.buffer.readByte() & FileDownloadStatus.error;
            }
    ...
    */
    ...
    public String readUtf8LineStrict(long j) throws IOException {
        ...
        if (j2 < LongCompanionObject.MAX_VALUE && request(j2) && this.buffer.getByte(j2 - 1) == 13 && request(j2 + 1) && this.buffer.getByte(j2) == 10) {
