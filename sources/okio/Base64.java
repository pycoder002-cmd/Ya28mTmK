...
final class Base64 {
    ...
    private static String encode(byte[] bArr, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 < length; i2 += 3) {
            int i3 = i + 1;
            bArr3[i] = bArr2[(bArr[i2] & FileDownloadStatus.error) >> 2];
            int i4 = i3 + 1;
            int i5 = i2 + 1;
            bArr3[i3] = bArr2[((bArr[i2] & 3) << 4) | ((bArr[i5] & FileDownloadStatus.error) >> 4)];
            int i6 = i4 + 1;
            int i7 = (bArr[i5] & 15) << 2;
            int i8 = i2 + 2;
            bArr3[i4] = bArr2[i7 | ((bArr[i8] & FileDownloadStatus.error) >> 6)];
            i = i6 + 1;
        ...
        switch (bArr.length % 3) {
            case 1:
                int i9 = i + 1;
                bArr3[i] = bArr2[(bArr[length] & FileDownloadStatus.error) >> 2];
                int i10 = i9 + 1;
            ...
            case 2:
                ...
                int i14 = length + 1;
                bArr3[i11] = bArr2[i13 | ((bArr[i14] & FileDownloadStatus.error) >> 4)];
