...
/* loaded from: apklis.apk:jacocoagent.jar:org/jacoco/agent/rt/internal_b0d6a23/asm/Label.class */
public class Label {
        ...
        while (i < this.referenceCount) {
            ...
            if (source >= 0) {
                ...
                if (offset < -32768 || offset > 32767) {
                    int opcode = data[reference - 1] & FileDownloadStatus.error;
                    if (opcode <= 168) {
    ...
    */
    public void visitSubroutine(org.jacoco.agent.rt.internal_b0d6a23.asm.Label r6, long r7, int r9) {
        /*
            r5 = this;
            r0 = r5
            r10 = r0
        ...
        Le3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.jacoco.agent.rt.internal_b0d6a23.asm.Label.visitSubroutine(org.jacoco.agent.rt.internal_b0d6a23.asm.Label, long, int):void");
    }
