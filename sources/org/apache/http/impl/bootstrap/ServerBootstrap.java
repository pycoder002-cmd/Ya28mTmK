...
public class ServerBootstrap {
    ...
    /* JADX WARN: Type inference failed for: r1v25, types: [org.apache.http.protocol.UriHttpRequestHandlerMapper] */
    ...
    public HttpServer create() {
        ...
        return new HttpServer(this.listenerPort > 0 ? this.listenerPort : 0, this.localAddress, this.socketConfig != null ? this.socketConfig : SocketConfig.DEFAULT, serverSocketFactory2, httpService, httpConnectionFactory2, this.sslSetupHandler, exceptionLogger);
    }
