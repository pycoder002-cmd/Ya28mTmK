...
public class ViewPager extends ViewGroup {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (infoForChild = infoForChild(childAt2)) != null) {
                    ...
                    if (layoutParams2.needsMeasure) {
                        ...
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.widthFactor), MemoryConstants.GB), View.MeasureSpec.makeMeasureSpec((i6 - i9) - i7, MemoryConstants.GB));
                    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(i7, MemoryConstants.GB);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(i6, MemoryConstants.GB);
        this.mInLayout = true;
        populate();
        ...
        for (int i13 = 0; i13 < childCount2; i13++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (i7 * layoutParams.widthFactor), MemoryConstants.GB), this.mChildHeightMeasureSpec);
            }
        }
    }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x00be, code lost:
        ...
        if (r8.position == r18.mCurItem) goto L34;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    void smoothScrollTo(int i, int i2, int i3) {
        ...
        int abs = Math.abs(i3);
        int min = Math.min(abs > 0 ? 4 * Math.round(1000.0f * Math.abs(distanceInfluenceForSnapDuration / abs)) : (int) (((Math.abs(i5) / ((f * this.mAdapter.getPageWidth(this.mCurItem)) + this.mPageMargin)) + 1.0f) * 100.0f), MAX_SETTLE_DURATION);
