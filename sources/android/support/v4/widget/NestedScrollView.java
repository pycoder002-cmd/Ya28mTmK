...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild2, ScrollingView {
    ...
    public boolean executeKeyEvent(@NonNull KeyEvent keyEvent) {
        ...
        if (!canScroll) {
            ...
            return (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(Opcodes.IXOR)) ? false : true;
        }
        ...
        if (keyCode != 62) {
            switch (keyCode) {
                ...
                case 20:
                    return !keyEvent.isAltPressed() ? arrowScroll(Opcodes.IXOR) : fullScroll(Opcodes.IXOR);
                default:
                    return false;
            }
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mFillViewport && View.MeasureSpec.getMode(i2) != 0 && getChildCount() > 0) {
            ...
            if (childAt.getMeasuredHeight() < measuredHeight) {
                childAt.measure(getChildMeasureSpec(i, getPaddingLeft() + getPaddingRight(), ((FrameLayout.LayoutParams) childAt.getLayoutParams()).width), View.MeasureSpec.makeMeasureSpec((measuredHeight - getPaddingTop()) - getPaddingBottom(), MemoryConstants.GB));
            }
        }
    }
