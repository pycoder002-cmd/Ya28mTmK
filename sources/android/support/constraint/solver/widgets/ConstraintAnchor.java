...
public class ConstraintAnchor {
    ...
    ConstraintAnchor findResolvedAnchor(int[] iArr) {
        ...
        if (this.mTarget.resolutionStatus == 1) {
            ConstraintAnchor constraintAnchor3 = this.mTarget.resolvedAnchor;
        ...
        while (true) {
            ...
            constraintAnchor = (constraintAnchor2.mTarget == null || constraintAnchor2.mTarget.mTarget == constraintAnchor2) ? null : constraintAnchor2.mTarget;
        }
    }
    ...
    String getResolutionStatus() {
        ...
        if (this.resolutionStatus == 0) {
            str = "{unresolved}";
        } else if (this.resolutionStatus == 1) {
            str = "**RESOLVED**";
