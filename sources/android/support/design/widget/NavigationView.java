...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (mode == Integer.MIN_VALUE) {
            i = View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i), this.mMaxWidth), MemoryConstants.GB);
        } else if (mode == 0) {
            i = View.MeasureSpec.makeMeasureSpec(this.mMaxWidth, MemoryConstants.GB);
        }
