...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j, double d, double d2) {
        double d3 = 6.24006f + (0.01720197f * (((float) (j - UTC_2000)) / 8.64E7f));
        double sin = (0.03341960161924362d * Math.sin(d3)) + d3 + (3.4906598739326E-4d * Math.sin(2.0f * r6)) + (5.236000106378924E-6d * Math.sin(3.0f * r6)) + 1.796593063d + 3.141592653589793d;
        double round = ((float) Math.round((r4 - J0) - r5)) + J0 + ((-d2) / 360.0d) + (0.0053d * Math.sin(d3)) + ((-0.0069d) * Math.sin(2.0d * sin));
