...
public final class Http2Reader implements Closeable {
    ...
    public static final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() throws IOException {
            ...
            byte readByte = (byte) (this.source.readByte() & FileDownloadStatus.error);
            this.flags = (byte) (this.source.readByte() & FileDownloadStatus.error);
    ...
    private void readData(Handler handler, int i, byte b, int i2) throws IOException {
        ...
        short readByte = (b & 8) != 0 ? (short) (this.source.readByte() & FileDownloadStatus.error) : (short) 0;
    ...
    static int readMedium(BufferedSource bufferedSource) throws IOException {
        return (bufferedSource.readByte() & FileDownloadStatus.error) | ((bufferedSource.readByte() & FileDownloadStatus.error) << 16) | ((bufferedSource.readByte() & FileDownloadStatus.error) << 8);
    }
    ...
    private void readPriority(Handler handler, int i) throws IOException {
        int readInt = this.source.readInt();
        handler.priority(i, readInt & Integer.MAX_VALUE, (this.source.readByte() & FileDownloadStatus.error) + 1, (Integer.MIN_VALUE & readInt) != 0);
    }
    ...
    public boolean nextFrame(boolean z, Handler handler) throws IOException {
        try {
            ...
            byte readByte2 = (byte) (this.source.readByte() & FileDownloadStatus.error);
