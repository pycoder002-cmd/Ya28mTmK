...
public class RippleDrawable extends Drawable implements Animatable, View.OnTouchListener {
    ...
    public static class Builder {
        ...
        public Builder(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            int type = Util.getType(obtainStyledAttributes, R.styleable.RippleDrawable_rd_maxRippleRadius);
            if (type < 16 || type > 31) {
                maxRippleRadius(obtainStyledAttributes.getDimensionPixelSize(R.styleable.RippleDrawable_rd_maxRippleRadius, Util.dpToPx(48)));
            } else {
                maxRippleRadius(obtainStyledAttributes.getInteger(R.styleable.RippleDrawable_rd_maxRippleRadius, -1));
            }
            rippleColor(obtainStyledAttributes.getColor(R.styleable.RippleDrawable_rd_rippleColor, Util.colorControlHighlight(context, 0)));
    ...
    private RippleDrawable(Drawable drawable, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, Interpolator interpolator, Interpolator interpolator2, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
        ...
        this.mAlpha = 255;
        this.mState = 0;
        this.mUpdater = new Runnable() { // from class: com.bvapp.arcmenulibrary.drawable.RippleDrawable.1
    ...
    public void updateTouch() {
        if (this.mState != 4) {
            ...
            setRippleEffect(this.mRipplePoint.x, this.mRipplePoint.y, this.mMaxRippleRadius * ((0.5f * this.mOutInterpolator.getInterpolation(min4)) + 1.0f));
        ...
        switch (motionEvent.getAction()) {
            ...
            case 2:
                if (this.mState != 0 && this.mState != 4) {
                    if (this.mRippleType == 0 && setRippleEffect(motionEvent.getX(), motionEvent.getY(), this.mRippleRadius)) {
                        invalidateSelf();
                        break;
                    }
                } else {
