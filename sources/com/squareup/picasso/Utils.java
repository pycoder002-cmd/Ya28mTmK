...
public final class Utils {
    ...
    public static int calculateMemoryCacheSize(Context context) {
        ...
        return (int) ((PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED * ((context.getApplicationInfo().flags & 1048576) != 0 ? activityManager.getLargeMemoryClass() : activityManager.getMemoryClass())) / 7);
    }
