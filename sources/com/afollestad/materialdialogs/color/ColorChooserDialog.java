...
public class ColorChooserDialog extends DialogFragment implements View.OnClickListener, View.OnLongClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        Builder builder = getBuilder();
        MaterialDialog.Builder showListener = new MaterialDialog.Builder(getActivity()).title(getTitle()).autoDismiss(false).customView(R.layout.md_dialog_colorchooser, false).negativeText(builder.cancelBtn).positiveText(builder.doneBtn).neutralText(builder.allowUserCustom ? builder.customBtn : 0).onPositive(new MaterialDialog.SingleButtonCallback() { // from class: com.afollestad.materialdialogs.color.ColorChooserDialog.4
        ...
        this.grid = (GridView) customView.findViewById(R.id.md_grid);
        if (builder.allowUserCustom) {
            this.selectedCustomColor = i;
            this.colorChooserCustomFrame = customView.findViewById(R.id.md_colorChooserCustomFrame);
            this.customColorHex = (EditText) customView.findViewById(R.id.md_hexInput);
            this.customColorIndicator = customView.findViewById(R.id.md_colorIndicator);
            this.customSeekA = (SeekBar) customView.findViewById(R.id.md_colorA);
            this.customSeekAValue = (TextView) customView.findViewById(R.id.md_colorAValue);
            this.customSeekR = (SeekBar) customView.findViewById(R.id.md_colorR);
            this.customSeekRValue = (TextView) customView.findViewById(R.id.md_colorRValue);
            this.customSeekG = (SeekBar) customView.findViewById(R.id.md_colorG);
            this.customSeekGValue = (TextView) customView.findViewById(R.id.md_colorGValue);
            this.customSeekB = (SeekBar) customView.findViewById(R.id.md_colorB);
            this.customSeekBValue = (TextView) customView.findViewById(R.id.md_colorBValue);
    ...
    public void onSaveInstanceState(Bundle bundle) {
        ...
        bundle.putBoolean("in_custom", this.colorChooserCustomFrame != null && this.colorChooserCustomFrame.getVisibility() == 0);
    }

    @NonNull
    public ColorChooserDialog show(AppCompatActivity appCompatActivity) {
        Builder builder = getBuilder();
        String str = builder.colorsTop != null ? "[MD_COLOR_CHOOSER]" : builder.accentMode ? "[MD_COLOR_CHOOSER]" : "[MD_COLOR_CHOOSER]";
