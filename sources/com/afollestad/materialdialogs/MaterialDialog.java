    ...
    public Drawable getButtonSelector(DialogAction dialogAction, boolean z) {
        ...
        switch (dialogAction) {
            ...
            case NEGATIVE:
                ...
                Drawable resolveDrawable4 = DialogUtils.resolveDrawable(this.builder.context, R.attr.md_btn_negative_selector);
            ...
            default:
                ...
                Drawable resolveDrawable6 = DialogUtils.resolveDrawable(this.builder.context, R.attr.md_btn_positive_selector);
