...
public class RatingBar extends LinearLayout {
    public static Map<String, String> a = new HashMap<String, String>() { // from class: com.startapp.sdk.json.RatingBar.1
        {
    ...
    public final void a(String str) {
        try {
            int a2 = d.a(getContext(), 2);
            int a3 = d.a(getContext(), 5);
            ImageView imageView = new ImageView(getContext());
            Bitmap a4 = a9.a(getContext(), str);
            if (a4 == null) {
                a4 = c9.a(a.get(str));
            }
            imageView.setImageBitmap(Bitmap.createScaledBitmap(a4, d.a(getContext(), 15), d.a(getContext(), 15), true));
