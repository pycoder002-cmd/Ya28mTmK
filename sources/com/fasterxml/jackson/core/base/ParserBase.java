...
public abstract class ParserBase extends ParserMinimalBase {
    ...
    static final BigInteger BI_MAX_LONG = BigInteger.valueOf(LongCompanionObject.MAX_VALUE);
    ...
    protected void reportOverflowLong() throws IOException {
        _reportError(String.format("Numeric value (%s) out of range of long (%d - %s)", getText(), Long.MIN_VALUE, Long.valueOf(LongCompanionObject.MAX_VALUE)));
    }
