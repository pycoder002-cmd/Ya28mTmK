...
public class UTF8DataInputJsonParser extends ParserBase {
    ...
    private final int _decodeUtf8_2(int i) throws IOException {
        ...
        if ((readUnsignedByte & Opcodes.CHECKCAST) != 128) {
    ...
    private final int _decodeUtf8_4(int i) throws IOException {
        ...
        if ((readUnsignedByte3 & Opcodes.CHECKCAST) != 128) {
    ...
    private final String _parseLongName(int i, int i2, int i3) throws IOException {
        ...
        while (true) {
            int readUnsignedByte = this._inputData.readUnsignedByte();
            if (iArr[readUnsignedByte] != 0) {
                return readUnsignedByte == 34 ? findName(this._quadBuffer, i5, i4, 1) : parseEscapedName(this._quadBuffer, i5, i4, readUnsignedByte, 1);
            }
            int i6 = (i4 << 8) | readUnsignedByte;
            int readUnsignedByte2 = this._inputData.readUnsignedByte();
            if (iArr[readUnsignedByte2] != 0) {
                return readUnsignedByte2 == 34 ? findName(this._quadBuffer, i5, i6, 2) : parseEscapedName(this._quadBuffer, i5, i6, readUnsignedByte2, 2);
            }
            int i7 = (i6 << 8) | readUnsignedByte2;
            int readUnsignedByte3 = this._inputData.readUnsignedByte();
            if (iArr[readUnsignedByte3] != 0) {
                return readUnsignedByte3 == 34 ? findName(this._quadBuffer, i5, i7, 3) : parseEscapedName(this._quadBuffer, i5, i7, readUnsignedByte3, 3);
            }
            int i8 = (i7 << 8) | readUnsignedByte3;
            int readUnsignedByte4 = this._inputData.readUnsignedByte();
            if (iArr[readUnsignedByte4] != 0) {
                return readUnsignedByte4 == 34 ? findName(this._quadBuffer, i5, i8, 4) : parseEscapedName(this._quadBuffer, i5, i8, readUnsignedByte4, 4);
            }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x002b, code lost:
        ...
        if (r2._parsingContext.inArray() == false) goto L38;
     */
