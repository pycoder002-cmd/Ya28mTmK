...
public final class NumberOutput {
    ...
    static {
        ...
        sSmallIntStrs = new String[]{"0", "1", ExifInterface.GPS_MEASUREMENT_2D, ExifInterface.GPS_MEASUREMENT_3D, "4", "5", AbstractConnection.SENTRY_PROTOCOL_VERSION, "7", "8", "9", "10"};
    ...
    private static int _outputFullBillion(int i, char[] cArr, int i2) {
        ...
        int i10 = TRIPLET_TO_CHARS[i3 - (i5 * 1000)];
        int i11 = i9 + 1;
        cArr[i9] = (char) (i10 >> 16);
        int i12 = i11 + 1;
    ...
    private static int _outputUptoBillion(int i, byte[] bArr, int i2) {
        ...
        int i7 = TRIPLET_TO_CHARS[i4 - (i6 * 1000)];
        int i8 = _leading3 + 1;
    ...
    public static int outputInt(int i, char[] cArr, int i2) {
        ...
        if (i < BILLION) {
            int i5 = i / 1000;
            int i6 = i5 / 1000;
            return _full3(i - (i5 * 1000), cArr, _full3(i5 - (i6 * 1000), cArr, _leading3(i6, cArr, i2)));
        }
        int i7 = i - BILLION;
        if (i7 >= BILLION) {
            i7 -= BILLION;
