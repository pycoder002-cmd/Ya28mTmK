        ...
        while (i < dataSets.size()) {
            ...
            if (iLineDataSet.isVisible() && iLineDataSet.isDrawCirclesEnabled() && iLineDataSet.getEntryCount() != 0) {
                ...
                while (i3 <= i2) {
                    ...
                    if (this.mViewPortHandler.isInBoundsLeft(this.mCirclesBuffer[r4]) && this.mViewPortHandler.isInBoundsY(this.mCirclesBuffer[1]) && (bitmap = dataSetImageCache.getBitmap(i3)) != null) {
                        canvas.drawBitmap(bitmap, this.mCirclesBuffer[r4] - circleRadius, this.mCirclesBuffer[1] - circleRadius, (Paint) null);
                    }
                    i3++;
                    r4 = 0;
                }
