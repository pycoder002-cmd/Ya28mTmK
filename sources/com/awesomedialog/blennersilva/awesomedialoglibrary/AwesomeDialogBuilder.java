...
public abstract class AwesomeDialogBuilder<T extends AwesomeDialogBuilder> {
    ...
    public void createDialog(AlertDialog.Builder builder) {
        this.dialogView = LayoutInflater.from(builder.getContext()).inflate(getLayout(), (ViewGroup) null);
    ...
    public T setColoredCircle(int i) {
        if (this.coloredCircle != null) {
            this.coloredCircle.getBackground().setColorFilter(ContextCompat.getColor(getContext(), i), PorterDuff.Mode.SRC_IN);
        }
        return this;
    }
