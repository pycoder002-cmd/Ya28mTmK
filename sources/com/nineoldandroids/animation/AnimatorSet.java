...
public final class AnimatorSet extends Animator {
    ...
    public static class Node implements Cloneable {
        ...
        public Node m10clone() {
            try {
                ...
                node.animation = this.animation.mo9clone();
                return node;
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet mo9clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo9clone();
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node m10clone = next.m10clone();
            hashMap.put(next, m10clone);
            animatorSet.mNodes.add(m10clone);
            animatorSet.mNodeMap.put(m10clone.animation, m10clone);
            ArrayList arrayList = null;
            m10clone.dependencies = null;
            m10clone.tmpDependencies = null;
            m10clone.nodeDependents = null;
            m10clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = m10clone.animation.getListeners();
            if (listeners != null) {
