...
public class ValueAnimator extends Animator {
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public ValueAnimator mo9clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.mo9clone();
        if (this.mUpdateListeners != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder mo13clone = propertyValuesHolderArr[i2].mo13clone();
                valueAnimator.mValues[i2] = mo13clone;
                valueAnimator.mValuesMap.put(mo13clone.getPropertyName(), mo13clone);
            }
        }
        return valueAnimator;
    }
