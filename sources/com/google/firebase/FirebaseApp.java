...
public class FirebaseApp {
    ...
    public static class zzc extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            synchronized (FirebaseApp.zzaox) {
                Iterator<FirebaseApp> it = FirebaseApp.aic.values().iterator();
                while (it.hasNext()) {
                    it.next().zzcnx();
                }
            }
    ...
    public static FirebaseApp initializeApp(Context context, FirebaseOptions firebaseOptions, String str) {
        ...
        synchronized (zzaox) {
            boolean z = !aic.containsKey(zzrq);
            StringBuilder sb = new StringBuilder(33 + String.valueOf(zzrq).length());
            sb.append("FirebaseApp name ");
            sb.append(zzrq);
            sb.append(" already exists!");
            zzaa.zza(z, sb.toString());
    ...
    private static List<String> zzcnw() {
        ...
        synchronized (zzaox) {
            Iterator<FirebaseApp> it = aic.values().iterator();
            while (it.hasNext()) {
    ...
    private void zzcs(boolean z) {
        ...
        Iterator<zzb> it = this.aWc.iterator();
        while (it.hasNext()) {
            it.next().zzcr(z);
        }
    }
    ...
    public void zza(@NonNull zzant zzantVar) {
        ...
        Iterator<zza> it = this.aWb.iterator();
        int i = 0;
        while (it.hasNext()) {
