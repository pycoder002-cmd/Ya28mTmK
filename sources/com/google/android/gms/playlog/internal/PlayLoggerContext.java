...
public class PlayLoggerContext extends AbstractSafeParcelable {
    ...
    public String toString() {
        return "PlayLoggerContext[versionCode=" + this.versionCode + ",package=" + this.packageName + ",packageVersionCode=" + this.aAB + ",logSource=" + this.aAC + ",logSourceName=" + this.aAG + ",uploadAccount=" + this.aAD + ",loggingId=" + this.aAE + ",logAndroidId=" + this.aAF + ",isAnonymous=" + this.aAH + ",qosTier=" + this.aAI + "]";
    }
