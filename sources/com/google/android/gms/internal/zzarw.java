...
public final class zzarw implements Cloneable {
    ...
    public int hashCode() {
        ...
        for (int i2 = 0; i2 < this.mSize; i2++) {
            i = this.btL[i2].hashCode() + (31 * ((i * 31) + this.btK[i2]));
        }
        return i;
    }
    ...
    public void zza(int i, zzarx zzarxVar) {
        ...
        if (this.mSize - i2 != 0) {
            int i3 = i2 + 1;
            System.arraycopy(this.btK, i2, this.btK, i3, this.mSize - i2);
            System.arraycopy(this.btL, i2, this.btL, i3, this.mSize - i2);
        }
        this.btK[i2] = i;
        this.btL[i2] = zzarxVar;
        this.mSize++;
