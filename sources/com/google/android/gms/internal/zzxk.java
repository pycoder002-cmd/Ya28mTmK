...
public interface zzxk extends IInterface {
    ...
    /* loaded from: classes.dex */
    public static abstract class zza extends Binder implements zzxk {

        /* renamed from: com.google.android.gms.internal.zzxk$zza$zza, reason: collision with other inner class name */
        /* loaded from: classes.dex */
        private static class C0041zza implements zzxk {
        ...
        public static zzxk zzks(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.search.internal.ISearchAuthCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzxk)) ? new C0041zza(iBinder) : (zzxk) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface("com.google.android.gms.search.internal.ISearchAuthCallbacks");
                    zzeh(parcel.readInt() != 0 ? Status.CREATOR.createFromParcel(parcel) : null);
                    return true;
                default:
    ...
    void zzeh(Status status) throws RemoteException;
}
