...
public final class zzaos {
    ...
    public void zzm(double d) {
        if (Double.isNaN(d) || Double.isInfinite(d)) {
            StringBuilder sb = new StringBuilder(Opcodes.JSR);
            sb.append(d);
    ...
    public <T> zzapk<T> zza(zzapl zzaplVar, zzaqo<T> zzaqoVar) {
        boolean z = !this.boc.contains(zzaplVar);
    ...
    public <T> zzapk<T> zza(zzaqo<T> zzaqoVar) {
        ...
        zza<?> zzaVar = map.get(zzaqoVar);
        if (zzaVar != null) {
            return zzaVar;
        }
        try {
            zza<?> zzaVar2 = new zza<>();
            map.put(zzaqoVar, zzaVar2);
            Iterator<zzapl> it = this.boc.iterator();
            while (it.hasNext()) {
                zzapk<T> zza2 = it.next().zza(this, zzaqoVar);
                if (zza2 != null) {
                    zzaVar2.zza(zza2);
                    this.bob.put(zzaqoVar, zza2);
                    return zza2;
                }
            }
            String valueOf = String.valueOf(zzaqoVar);
