...
public final class zzsj extends Drawable implements Drawable.Callback {
    ...
    private static final class zza extends Drawable {
        ...
        private static final C0033zza Da = new C0033zza();
    ...
    public zzsj(Drawable drawable, Drawable drawable2) {
        ...
        zzb zzbVar = this.CS;
        zzbVar.Db = drawable.getChangingConfigurations() | zzbVar.Db;
        drawable2 = drawable2 == null ? zza.CZ : drawable2;
        this.CU = drawable2;
        drawable2.setCallback(this);
        zzb zzbVar2 = this.CS;
        zzbVar2.Db = drawable2.getChangingConfigurations() | zzbVar2.Db;
    }
        ...
        switch (this.CM) {
            ...
            case 2:
                if (this.eg >= 0) {
                    ...
                    this.CQ = (int) (0.0f + ((this.CN - 0) * Math.min(uptimeMillis, 1.0f)));
                    break;
                }
                break;
        }
