...
public interface zznf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznf {
        ...
        /* loaded from: classes.dex */
        private static class C0029zza implements zznf {
        ...
        public static zznf zzbn(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznf)) ? new C0029zza(iBinder) : (zznf) queryLocalInterface;
        }
