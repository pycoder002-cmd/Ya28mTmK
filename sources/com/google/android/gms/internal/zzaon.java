...
final class zzaon implements zzaox<Date>, zzapg<Date> {
            ...
            try {
                try {
                    try {
                        ...
                        return this.bnQ.parse(zzaoyVar.aU());
                    }
                } catch (ParseException e) {
                    throw new zzaph(zzaoyVar.aU(), e);
                }
            } catch (ParseException unused2) {
                return this.bnS.parse(zzaoyVar.aU());
            }
        }
        return parse;
    }
    ...
    public String toString() {
        return zzaon.class.getSimpleName() + '(' + this.bnR.getClass().getSimpleName() + ')';
    }
