...
public interface zzaf {
    ...
    public static final class zza extends zzaru<zza> {
        ...
        public C0026zza[] zzet = C0026zza.zzaa();
        ...
        /* loaded from: classes.dex */
        public static final class C0026zza extends zzaru<C0026zza> {
            private static volatile C0026zza[] zzfc;
            public Long zzdn = null;
            public Long zzdo = null;
            ...
            public C0026zza zzb(zzars zzarsVar) throws IOException {
                while (true) {
                    int bU = zzarsVar.bU();
                    switch (bU) {
                        case 0:
        ...
        public void zza(zzart zzartVar) throws IOException {
            ...
            if (this.zzet != null && this.zzet.length > 0) {
                for (int i = 0; i < this.zzet.length; i++) {
                    C0026zza c0026zza = this.zzet[i];
                    if (c0026zza != null) {
                        zzartVar.zza(43, c0026zza);
                    }
                }
            }
            if (this.zzei != null) {
            ...
            while (true) {
                ...
                switch (bU) {
                    ...
                    case 346:
                        ...
                        C0026zza[] c0026zzaArr = new C0026zza[zzc + length];
                        if (length != 0) {
                            System.arraycopy(this.zzet, 0, c0026zzaArr, 0, length);
                        }
                        while (length < c0026zzaArr.length - 1) {
                            c0026zzaArr[length] = new C0026zza();
                            zzarsVar.zza(c0026zzaArr[length]);
                            zzarsVar.bU();
                            length++;
                        }
                        c0026zzaArr[length] = new C0026zza();
                        zzarsVar.zza(c0026zzaArr[length]);
                        this.zzet = c0026zzaArr;
                    case 352:
    ...
    public static final class zzf extends zzaru<zzf> {
        ...
        public int zzx() {
            ...
            if (this.zzga != null && this.zzga.length > 0) {
                int i = 0;
                int i2 = 0;
                for (int i3 = 0; i3 < this.zzga.length; i3++) {
            ...
            if (this.zzgb != null) {
                zzx += zzart.zzah(3, this.zzgb.intValue());
            }
            return this.zzgc != null ? zzx + zzart.zzah(4, this.zzgc.intValue()) : zzx;
        }
    }
}
