...
public interface zzcl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcl {
        ...
        /* loaded from: classes.dex */
        private static class C0028zza implements zzcl {
        ...
        public static zzcl zzf(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcl)) ? new C0028zza(iBinder) : (zzcl) queryLocalInterface;
        }
