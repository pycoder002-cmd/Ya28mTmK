...
public final class zzapw<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> bpi = new Comparator<Comparable>() { // from class: com.google.android.gms.internal.zzapw.1
    ...
    public static final class zzd<K, V> implements Map.Entry<K, V> {
        ...
        public zzd<K, V> bm() {
            zzd<K, V> zzdVar = this;
            for (zzd<K, V> zzdVar2 = this.bpu; zzdVar2 != null; zzdVar2 = zzdVar2.bpu) {
                zzdVar = zzdVar2;
            }
            return zzdVar;
        }
        ...
        public zzd<K, V> bn() {
            zzd<K, V> zzdVar = this;
            for (zzd<K, V> zzdVar2 = this.bpv; zzdVar2 != null; zzdVar2 = zzdVar2.bpv) {
                zzdVar = zzdVar2;
            }
            return zzdVar;
        }
