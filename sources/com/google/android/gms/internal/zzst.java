...
public interface zzst extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzst {
        ...
        /* loaded from: classes.dex */
        private static class C0035zza implements zzst {
        ...
        public static zzst zzeb(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzst)) ? new C0035zza(iBinder) : (zzst) queryLocalInterface;
        }
