...
public class zzv implements com.google.android.gms.internal.zzb {
    ...
    private void zzc(int i) {
        ...
        while (true) {
            ...
            it.remove();
            i2++;
            if (((float) (this.zzbx + j2)) < this.zzbz * 0.9f) {
                break;
            }
            j3 = j2;
            elapsedRealtime = j;
        ...
        if (zzs.DEBUG) {
            zzs.zza("pruned %d files, %d bytes, %d ms", Integer.valueOf(i2), Long.valueOf(this.zzbx - j4), Long.valueOf(SystemClock.elapsedRealtime() - j));
        }
    }
    ...
    public synchronized zzb.zza zza(String str) {
        ...
        try {
            ...
            try {
                zza.zzf(zzbVar);
                zzb.zza zzb2 = zzaVar.zzb(zza(zzbVar, (int) (zzf.length() - zzbVar.zzcc)));
                if (zzbVar != null) {
                    try {
                        zzbVar.close();
                    } catch (IOException unused) {
