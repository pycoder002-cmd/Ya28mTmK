...
public class zzs {
    ...
    public static class zza {
        ...
        private final List<C0032zza> zzbk = new ArrayList();
        ...
        public static class C0032zza {
            ...
            public C0032zza(String str, long j, long j2) {
                this.name = str;
                this.zzbm = j;
                this.time = j2;
            }
        ...
        public synchronized void zza(String str, long j) {
            ...
            this.zzbk.add(new C0032zza(str, j, SystemClock.elapsedRealtime()));
        }
        ...
        public synchronized void zzd(String str) {
            ...
            for (C0032zza c0032zza : this.zzbk) {
                long j2 = c0032zza.time;
                zzs.zzb("(+%-4d) [%2d] %s", Long.valueOf(j2 - j), Long.valueOf(c0032zza.zzbm), c0032zza.name);
                j = j2;
            }
        }
    }
