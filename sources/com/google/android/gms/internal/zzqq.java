...
public abstract class zzqq<R extends Result> extends PendingResult<R> {
    ...
    public final R await() {
        ...
        com.google.android.gms.common.internal.zzaa.zza(!this.yO, "Result has already been consumed");
        com.google.android.gms.common.internal.zzaa.zza(this.yR == null, "Cannot await if then() has been called.");
        try {
            this.zzank.await();
    ...
    public <S extends Result> TransformedResult<S> then(ResultTransform<? super R, ? extends S> resultTransform) {
        ...
        synchronized (this.yH) {
            ...
            com.google.android.gms.common.internal.zzaa.zza(this.yL == null, "Cannot call then() if callbacks are set.");
            this.yS = true;
