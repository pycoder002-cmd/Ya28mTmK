...
public class GoogleApiAvailability extends zzc {
    ...
    @TargetApi(14)
    public Dialog zza(Context context, int i, zzh zzhVar, DialogInterface.OnCancelListener onCancelListener) {
    ...
    void zza(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (zzi.zzci(context)) {
            zzaa.zzbs(zzs.zzayv());
            build = new Notification.Builder(context).setSmallIcon(context.getApplicationInfo().icon).setPriority(2).setAutoCancel(true).setContentTitle(zzh).setStyle(new Notification.BigTextStyle().bigText(zzj)).addAction(com.google.android.gms.R.drawable.common_full_open_on_phone, resources.getString(com.google.android.gms.R.string.common_open_on_phone), pendingIntent).build();
        } else {
