...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        public Field(int i, int i2, boolean z, int i3, boolean z2, String str, int i4, String str2, ConverterWrapper converterWrapper) {
            ...
            this.Fp = converterWrapper != null ? (zza<I, O>) converterWrapper.zzawx() : zzaVar;
        }
        ...
        protected Field(int i, boolean z, int i2, boolean z2, String str, int i3, Class<? extends FastJsonResponse> cls, zza<I, O> zzaVar) {
            ...
            this.Fl = i3;
            this.Fm = cls;
            this.Fn = cls == null ? null : cls.getCanonicalName();
            this.Fp = zzaVar;
        }
    ...
    private void zza(StringBuilder sb, Field field, Object obj) {
        String str;
        if (field.zzaxa() == 11) {
            str = field.zzaxg().cast(obj).toString();
    ...
    public String toString() {
        ...
        for (String str2 : zzawz.keySet()) {
            Field<?, ?> field = zzawz.get(str2);
            if (zza(field)) {
                ...
                if (zza2 == null) {
                    ...
                    switch (field.zzaxc()) {
                        case 8:
                            sb.append("\"");
                            zzq = com.google.android.gms.common.util.zzc.zzq((byte[]) zza2);
                            break;
                        case 9:
                            sb.append("\"");
                            zzq = com.google.android.gms.common.util.zzc.zzr((byte[]) zza2);
                            break;
                        case 10:
