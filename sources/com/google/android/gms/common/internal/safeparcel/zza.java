...
public class zza {
    ...
    public static class C0010zza extends RuntimeException {
        ...
        */
        public C0010zza(java.lang.String r5, android.os.Parcel r6) {
            /*
                r4 = this;
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.internal.safeparcel.zza.C0010zza.<init>(java.lang.String, android.os.Parcel):void");
        }
    }
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        if (zza != i2) {
            ...
            sb.append(valueOf);
            sb.append(")");
            throw new C0010zza(sb.toString(), parcel);
        }
    }
    ...
    public static int zzcr(Parcel parcel) {
        ...
        if (zzgu(zzcq) != 20293) {
            ...
            throw new C0010zza(valueOf.length() != 0 ? "Expected object header. Got 0x".concat(valueOf) : new String("Expected object header. Got 0x"), parcel);
        }
