...
public abstract class zze<T extends IInterface> {
    ...
    protected zzf Dr;
    private T Ds;
    private final ArrayList<AbstractC0011zze<?>> Dt;
    private zzh Du;
    private int Dv;
    ...
    /* loaded from: classes.dex */
    private abstract class zza extends AbstractC0011zze<Boolean> {
        ...
        @Override // com.google.android.gms.common.internal.zze.AbstractC0011zze
        ...
        public void zzv(Boolean bool) {
            ...
            if (i != 0) {
                ...
                zze.this.zzb(1, null);
                connectionResult = new ConnectionResult(this.statusCode, this.DC != null ? (PendingIntent) this.DC.getParcelable("pendingIntent") : null);
            } else {
                if (zzavj()) {
                    return;
                }
    ...
    final class zzd extends Handler {
        ...
        private void zza(Message message) {
            AbstractC0011zze abstractC0011zze = (AbstractC0011zze) message.obj;
            abstractC0011zze.zzavk();
            abstractC0011zze.unregister();
        }
        ...
        public void handleMessage(Message message) {
            ...
            if (zzb(message)) {
                ((AbstractC0011zze) message.obj).zzavl();
                return;
            }
            int i = message.what;
    ...
    /* loaded from: classes.dex */
    public abstract class AbstractC0011zze<TListener> {
        private boolean DE = false;
        private TListener mListener;

        public AbstractC0011zze(TListener tlistener) {
