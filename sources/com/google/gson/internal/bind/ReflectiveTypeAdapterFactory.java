            ...
            while (i < length) {
                ...
                if (excludeField || excludeField2) {
                    ...
                    while (r2 < size) {
                        ...
                        Type type2 = resolve;
                        Field field2 = field;
                        boundField = boundField2 == null ? (BoundField) linkedHashMap.put(str, reflectiveTypeAdapterFactory2.createBoundField(gson, field, str, TypeToken.get(resolve), z3, excludeField2)) : boundField2;
                        z2 = z3;
                        resolve = type2;
                        size = i3;
                        fieldNames = list;
