...
public class Data3 {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.reviewsCount != null ? this.reviewsCount.equals(data3.reviewsCount) : data3.reviewsCount == null) {
            if (this.reviewsStar5 != null ? this.reviewsStar5.equals(data3.reviewsStar5) : data3.reviewsStar5 == null) {
                if (this.reviewsStar4 != null ? this.reviewsStar4.equals(data3.reviewsStar4) : data3.reviewsStar4 == null) {
                    if (this.price != null ? this.price.equals(data3.price) : data3.price == null) {
                        if (this.reviewsStar3 != null ? this.reviewsStar3.equals(data3.reviewsStar3) : data3.reviewsStar3 == null) {
                            if (this._public != null ? this._public.equals(data3._public) : data3._public == null) {
                                if (this.reviewsStar2 != null ? this.reviewsStar2.equals(data3.reviewsStar2) : data3.reviewsStar2 == null) {
                                    if (this.sponsored != null ? this.sponsored.equals(data3.sponsored) : data3.sponsored == null) {
                                        if (this.reviewsStar1 != null ? this.reviewsStar1.equals(data3.reviewsStar1) : data3.reviewsStar1 == null) {
                                            if (this.deleted != null ? this.deleted.equals(data3.deleted) : data3.deleted == null) {
                                                if (this.description != null ? this.description.equals(data3.description) : data3.description == null) {
                                                    if (this.releasesCount == null) {
                                                        if (data3.releasesCount == null) {
                                                            return true;
                                                        }
                                                    } else if (this.releasesCount.equals(data3.releasesCount)) {
                                                        return true;
                                                    }
                                                }
                                            }
