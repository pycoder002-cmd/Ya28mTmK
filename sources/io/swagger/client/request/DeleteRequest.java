...
public class DeleteRequest extends Request<String> {
    ...
    public DeleteRequest(String str, Map<String, String> map, String str2, HttpEntity httpEntity, Response.Listener<String> listener, Response.ErrorListener errorListener) {
