...
public class CollectionsKt__MutableCollectionsKt extends CollectionsKt__IteratorsKt {
    ...
    public static final <T> boolean retainAll(@NotNull Collection<? super T> receiver, @NotNull Sequence<? extends T> elements) {
        ...
        Intrinsics.checkParameterIsNotNull(elements, "elements");
        HashSet hashSet = SequencesKt.toHashSet(elements);
        return hashSet.isEmpty() ^ true ? receiver.retainAll(hashSet) : retainNothing$CollectionsKt__MutableCollectionsKt(receiver);
    }

    public static final <T> boolean retainAll(@NotNull Collection<? super T> receiver, @NotNull T[] elements) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(elements, "elements");
        return true ^ (elements.length == 0) ? receiver.retainAll(ArraysKt.toHashSet(elements)) : retainNothing$CollectionsKt__MutableCollectionsKt(receiver);
    }
